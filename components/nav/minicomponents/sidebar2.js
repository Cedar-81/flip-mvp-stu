...
function Sidebar2() {
  const { setShelf2, setSidebartype, setNotetype } = useContext(StudentContext);
  return (
    <div className="notification w-[100vw] pt-8 md:w-[20rem] md:h-[20rem] md:rounded-md items-center h-full bg-main_color">
